    ...
    let html = `
      ...
      <head>
        ...
        <style>
          ...
          body { font-family: Arial, sans-serif; padding: 25px; color: #000; line-height: 1.5; font-size: 14px; }
          ...
          h1 { color: #d9534f; margin: 0; font-size: 18px; text-transform: uppercase; }

          h2 { color: #333; font-size: 18px; margin-top: 25px; border-bottom: 2px solid #007bff; padding-bottom: 4px; text-transform: uppercase; background: #eef2f5; padding-left: 8px; }

          h3 { color: #0056b3; font-size: 18px; margin: 12px 0 4px 0; text-transform: uppercase; }
          ...
          .incidente-item { background: #fff5f5; border-left: 3px solid #d9534f; padding: 6px 10px; margin: 4px 0; font-size: 14px; }
